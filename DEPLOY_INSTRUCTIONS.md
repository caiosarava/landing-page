...
**Observação:** O código utiliza por padrão o modelo `google/diffusiongemma-26b-a4b-it` através do endpoint `https://integrate.api.nvidia.com/v1/chat/completions`.
